import { AbsoluteFill, Sequence, useVideoConfig, Img, Audio, useCurrentFrame, interpolate } from 'remotion';
        ...
        <AbsoluteFill classname="bg-black">
            {imageList?.map((item, index) => {
                ...
                const scale = (index) => interpolate(
                    frame,
                    [startTime, startTime + duration/2, startTime+duration], //For zooming in and zooming out
